...
if ($_SERVER['REQUEST_METHOD'] === 'GET' && $clientType && $apiType && $resourceType) {
    ...
    if ($accessToken && empty($errors)) {
        ...
        // If user provided a query string, append it and skip defaults
        ...
        if ($queryUser !== '') {
            ...
            // No user query provided -> keep your existing friendly defaults
        }
        ...
        <form method="get" class="mb-2">
            ...
            <div class="form-inline">
                ...
                <div class="form-group mr-2 mt-2">
                    <label class="mr-1" for="query">Query</label>
                    ...
                    <div class="input-group-append">
                        <button type="button" class="btn btn-outline-warning" id="clearQueryBtn" title="Clear input">
                            Clear
                        </button>
                    </div>
